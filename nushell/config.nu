...
let tomorrow_night = {
    ...
    header: { fg: "#81a2be" attr: "b" }
    empty: "#cc6666"
    bool: {|| if $in { "#b5bd68" } else { "#8abeb7" } }
    int: "#cc6666"
    filesize: {|e|
        if $e == 0b {
            "#c5c8c6"
    ...
    shape_directory: "#b5bd68"  # Changed folder color to green
    ...
    shape_vardecl: { fg: "#b294bb" attr: "b" }
    # Tomorrow Night color schem
}
let light_theme = {
    separator: dark_gray
...
$env.config = {
    ...
    color_config: $tomorrow_night # if you want a more interesting theme, you can replace the empty record with `$dark_theme`, `$light_theme` or another custom record
